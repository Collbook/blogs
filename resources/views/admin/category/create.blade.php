...
<div class="container-fluid">
        <div class="block-header">
            <a href="{{ route('admin.category.index') }}" class="btn bg-blue waves-effect">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form method="POST" action="{{ route('admin.category.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="file" id="image" name="image" class="form-control" placeholder="Enter your image name">
                                </div>
                            </div>

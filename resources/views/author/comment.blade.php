                                    ...
                                    @foreach($comments as $key=>$comment)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form id="delete-form-{{ $comment->id }}" method="POST" action="{{ route('author.comments.destroy',$comment->id) }}" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
...
@push('js')
    ...
    <script type="text/javascript">
        function deleteComment(id) {
            ...
            title: 'Are you sure?',
            text: "You won't removed comment post this!",
            type: 'warning',
            ...
            if (result.value) {
                ...
                swalWithBootstrapButtons(
                'Cancelled',
                'Your emoved comment post is safe :)',
                'error'
                )
            }
            })

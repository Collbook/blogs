...
<div class="container-fluid">
        ...
        <form method="POST" action="{{ route('author.post.update',['id'=>$post->id]) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <!-- Vertical Layout -->
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="title" name="title" value="{{ $post->title }}" class="form-control" placeholder="Enter your post name">
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="file" id="image" name="image"  class="form-control" placeholder="Enter your image file">
                                </div>
                            </div>
                            <br>
                                            ...
                                            @foreach ($categories as $categorie)
                                                ...
                                                {{-- edit post --}}
                                                    @foreach ($post->categories as $postCate)
                                                        {{ $postCate->id == $categorie->id ? 'selected' : ''  }}
                                                    @endforeach

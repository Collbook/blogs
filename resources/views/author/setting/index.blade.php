                ...
                <div class="body">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active in" id="profile_with_icon_title">                            
                            ...
                            <form method="POST" action="{{ route('author.profile.update',['id'=>Auth::user()->id]) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="change_password_with_icon_title">
                            @include('layouts.backend.partial.message')
                            <form method="POST" action="{{ route('author.password.update',['id'=>Auth::user()->id]) }}">
                                @csrf
                                @method('PUT')
...
<!-- TinyMCE -->
   <script src="http://blogs.test/assets/backend/plugins/tinymce/tinymce.js"></script>
   ...
   <script>
        $(function () {
            ...
            tinymce.suffix = ".min";
            tinyMCE.baseURL = 'http://blogs.test/assets/backend/plugins/tinymce';
        });
   </script>

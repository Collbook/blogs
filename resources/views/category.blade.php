...
<link href="{{ asset('assets/frontend/css/category/styles.css') }}" rel="stylesheet">
	...
	<style type="text/css">
		...
		/* .slider {
            height: 400px;
            width: 100%;
            background-image: url({{ Storage::disk('public')->url('category/'.$categories->image) }});
...
@section('content')
    ...
    <section class="blog-area section">
        <div class="container">
            ...
            <div class="row">
				...
				<div class="col-lg-12 col-md-12">
						<div class="card h-100">
							<div class="single-post post-style-1">
								<div class="blog-info">
									<h4 class="title">Sorry, No post found for category !</h4>
								</div><!-- blog-info -->
							</div><!-- single-post -->
						</div><!-- card -->
					</div><!-- col-lg-4 col-md-6 -->
            ...
            <div class="float-right">page</div><br>
